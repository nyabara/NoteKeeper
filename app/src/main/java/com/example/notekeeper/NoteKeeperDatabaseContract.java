...
public final class NoteKeeperDatabaseContract {
    ...
    public static final class CourseInfoEntry implements BaseColumns{
        ...
        public static final String SQL_CREATE_INDEX1="CREATE INDEX " + INDEX1 + " ON " + TABLE_NAME + " (" + COLUMN_COURSE_TITLE
                 + ")";
        public static final String COURSE_INFO_SQL= "CREATE TABLE " + TABLE_NAME + " (" + _ID + " INTEGER PRIMARY KEY, " +
    ...
    public static final class NoteInfoEntry implements BaseColumns{
        ...
        public static final String SQL_CREATE_INDEX1="CREATE INDEX " + INDEX1 + " ON " + TABLE_NAME + " (" + COLUMN_NOTE_TITLE
                + ")";
        public static final String NOTE_INFO_SQL = "CREATE TABLE " + TABLE_NAME + " (" + _ID +
                " INTEGER PRIMARY KEY, " + COLUMN_COURSE_ID +
                " TEXT NOT NULL, " + COLUMN_NOTE_TITLE + " TEXT NOT NULL, " + COLUMN_NOTE_TEXT + " TEXT)";
    }
